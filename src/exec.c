...
void racs_exec_init(racs_exec *exec) {
    ...
    racs_kvstore_put(exec->kv, strdup("STREAMCREATE"), racs_command_streamcreate);
    racs_kvstore_put(exec->kv, strdup("STREAMINFO"), racs_command_streaminfo);
    racs_kvstore_put(exec->kv, strdup("STREAMOPEN"), racs_command_streamopen);
    racs_kvstore_put(exec->kv, strdup("STREAMCLOSE"), racs_command_streamclose);
    racs_kvstore_put(exec->kv, strdup("STREAMLIST"), racs_command_streamlist);
