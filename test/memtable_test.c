...
void test_multi_memtable() {
    ...
    racs_multi_memtable* mmt = racs_multi_memtable_create(2, 2);
    ...
    key[1] = 1739141512213;
    racs_multi_memtable_append(mmt, key, flac_data1, size1);

    key[1] = 1739141512214;
    racs_multi_memtable_append(mmt, key, flac_data2, size2);

    key[1] = 1739141512215;
    racs_multi_memtable_append(mmt, key, flac_data3, size3);

    key[1] = 1739141512216;
    racs_multi_memtable_append(mmt, key, flac_data4, size4);

    racs_multi_memtable_destroy(mmt);
