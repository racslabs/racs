...
void test_scm_extract() {
    ...
    racs_result res = racs_db_exec(db, "EVAL '(extract \"test\" \"2025-02-09T22:51:52.213Z\" \"2025-02-09T22:51:52.215Z\")'");
...
void test_scm_create() {
    ...
    racs_result res = racs_db_exec(db, "EVAL '(create \"test\" 44100 1)'");
...
void test_scm_int() {
    ...
    racs_result res = racs_db_exec(db, "EVAL '(+ 1 2)'");
...
void test_scm_metadata() {
    ...
    racs_result res = racs_db_exec(db, "EVAL '(streaminfo \"test\" \"rate\")'");
